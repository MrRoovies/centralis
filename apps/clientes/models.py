...
from apps.core.choices import Estado
...
class Bancos(models.Model):
    ...
    cor_primaria = models.CharField('Cor 1', max_length=7, null=True, blank=True)
    cor_secundaria = models.CharField('Cor 2', max_length=7, null=True, blank=True)
